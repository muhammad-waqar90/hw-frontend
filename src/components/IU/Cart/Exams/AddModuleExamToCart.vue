    ...
    <div class="row">
      <div class="col-12 col-md-6" :class="{ 'px-0': $isPhone }">
        <div :class="$isPhone ? 'px-0' : 'px-3'">
          <div
            :class="{
              'px-3 py-1 d-flex justify-content-center': $isPhone,
            }"
          >
            <div
              class="img rounded-card d-flex align-items-center justify-content-center text-white"
              :class="{ 'mob-img': $isPhone }"
            >
              <SchoolIcon :size="150" />
            </div>
          </div>
...
<script>
import ExamSquareCheckbox from "@/components/IU/Cart/Exams/ExamSquareCheckbox";
