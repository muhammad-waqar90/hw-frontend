  ...
  <section class="container-fluid">
    <article id="enrolled-courses" class="w-100">
      <div class="d-flex justify-content-between py-4">
        <h3 class="w-100">Support Tickets</h3>
      </div>
...
<script>
import TicketList from "@/components/AF/Tickets/TicketList";
...
import {
  ...
  REFUND,
  GDPR,
} from "@/dataObject/tickets/ticketCategoryData";
...
export default {
  ...
  methods: {
    ...
    mapData() {
      if (this.$isTicketSystemManager) {
        this.categories.push({ name: "system", id: SYSTEM });
      }
      if (this.$isTicketContentManager) {
        this.categories.push({ name: "content", id: CONTENT });
      }
      if (this.$isTicketRefundManager) {
        this.categories.push({ name: "refund", id: REFUND });
      }
      if (this.$isTicketGDPRManager) {
        this.categories.push({ name: "gdpr", id: GDPR });
      }

      this.categories.push({ name: "all", id: null });
