...
<script>
import ForgotUsernameLeftSection from "@/components/Auth/ForgotUsernameLeftSection.vue";
import ForgotUsernameRightSection from "@/components/Auth/ForgotUsernameRightSection.vue";
import { requestForgotUsernameService } from "@/services/authService";
...
export default {
  ...
  components: { ForgotUsernameLeftSection, ForgotUsernameRightSection },
  ...
  methods: {
    async onSubmit(data) {
      this.loading = true;
      const response = await requestForgotUsernameService(data);
